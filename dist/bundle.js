...
let form = {
    ...
    view: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("form", {
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("input.input[type=text][placeholder=Comment]", {
                oninput: function (e) {
...
let inForm = {
    ...
    view: function () {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("main.container", [
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("form", {
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=submit][value=Submit].button", "Submit")
            ]),
    ...
    test: function () {
        console.log(_models_orders_js__WEBPACK_IMPORTED_MODULE_1__.orders.current);
    }
};
        ...
        return [
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("table.table.table-scroll.table-striped", [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("thead", [
                    ...
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("th", "Price"),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("th", "Fakturadatum"),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("th", "Förfallodatum")
                ])
            ]),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("tbody", _models_invoices_js__WEBPACK_IMPORTED_MODULE_2__.invoicesModel.invoices.map(function(invoice) {
                return mithril__WEBPACK_IMPORTED_MODULE_0___default()("tr", [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("td", invoice.name),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("td", invoice.total_price),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("td", invoice.creation_date),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("td", invoice.due_date)
                ]);
            })),
    ...
    view: function () {
        return [
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("form", {
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=submit][value=Log in].button", "Log In"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {
                    selector: "button",
                    href: "/register",
                    class: "form-button"
